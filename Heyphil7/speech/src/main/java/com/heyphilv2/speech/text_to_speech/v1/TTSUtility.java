...
package com.heyphilv2.speech.text_to_speech.v1;
...
import com.heyphilv2.speech.speech_to_text.v1.opus.OggOpus;
...
import com.heyphilv2.speech.speech_to_text.v1.audio.PcmWaveWriter;
...
public class TTSUtility extends Application {
    ...
    public void stopTtsPlayer2() {
        try {
            ...
            //        "Something happened. Please press mic button again.",
	...
	public void stopTtsPlayer() {
        /*if(audioTrack!=null){
            System.out.println("AUDIO STATE IS "+audioTrack.getPlayState());
        ...
        if (audioTrack != null && audioTrack.getState() != AudioTrack.STATE_UNINITIALIZED ) {
            System.out.println("AUDIO is "+audioTrack.getState());
