...
/**
 * Created by HCNatividad on 9/9/2016.
 */
public final class StreamPlayer {
    ...
    public void stopStream() {
        try{
            ...
            int bs = AudioTrack.getMinBufferSize(8000, AudioFormat.CHANNEL_OUT_MONO, AudioFormat.ENCODING_PCM_16BIT);
            ...
            if (audioTrack != null){
                System.out.println("STREAM PLAYER === IF");
                audioTrack.flush();
                audioTrack.stop();
                audioTrack.release();
            }else{
                System.out.println("STREAM PLAYER === ELSE");
                audioTrack.flush();
                audioTrack.stop();
                audioTrack.release();
            }
